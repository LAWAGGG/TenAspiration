            ...
            <div
                ...
                <div class="bg-white px-4 sm:px-6 pt-6 pb-4">
                    ...
                    <form method="POST" action="{{ route('form_questions.update_entity', ['formType' => 'event', 'entityId' => $eventId]) }}">
                        @csrf
                        @method('PUT')
                        <div id="questions-container" class="space-y-4 mb-4 max-h-[60vh] overflow-y-auto">
                ...
                async handleBulkDelete() {
                    ...
                    try {
                        ...
                        if (response.ok) {
                            ...
                            window.dispatchEvent(new CustomEvent('notify', { detail: { message: result.message || 'Gagal menghapus aspirasi event', type: 'error' } }));
                        }
                    } catch (error) {
                        console.error('Gagal menghapus massal:', error);
                        window.dispatchEvent(new CustomEvent('notify', { detail: { message: 'Terjadi kesalahan saat menghapus', type: 'error' } }));
