            ...
            return {
                ...
                async showDetail(messageId) {
                    ...
                    try {
                        ...
                        window.dispatchEvent(new CustomEvent('notify', { detail: { message: 'Gagal memuat detail keluh kesah', type: 'error' } }));
                    }
                },
                ...
                async handleBulkDelete() {
                    ...
                    try {
                        ...
                        if (response.ok) {
                            ...
                            window.dispatchEvent(new CustomEvent('notify', { detail: { message: result.message || 'Gagal menghapus keluh kesah', type: 'error' } }));
                        }
                    } catch (error) {
